...
/******************************************************************************
* System Name	: Car Audio
* File Name 	: if_lcd.c
* Abstract 		: Interface of LCD
* Version 		: Ver 0.10
* Device 		: R5F212A7SNFP(R8C/2A Group)
* Tool-Chain 	: High-performance Embedded Workshop (Version 4.08.00.011)
* 				: C Compiler Package for M16C Series M3T-NC30WA(V.5.45 Release 00)
* OS 			: None
* H/W Platform 	: Car audio demo board with AE1
* Description 	: This is interface of lcd.
