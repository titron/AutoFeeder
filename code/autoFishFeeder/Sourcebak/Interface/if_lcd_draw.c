...
* Include		 : none
* Declaration	 : void LCD_DrawLine(U8 PosStartX,U8 PosStartY,U8 DrawLine)
...
*****************************************************************************/
void LCD_DrawLine(U16 PosStartX,U16 PosStartY,U16 PosEndX,U16 PosEndY,U8 col)
{
...
* Include		 : none
* Declaration	 : void LCD_DrawLineT(U8 PosStartX,U8 PosStartY,U8 DrawLine)
* Description	 : LCD draw vertical line
* Argument 		 : PosStartX, X axis
: PosStartY, Y axis
: PosEndX, X axis
...
* Calling Functions : none
*****************************************************************************/
void LCD_DrawLineT(U16 PosStartX,U16 PosStartY,U16 PosEndX,U16 PosEndY,U8 col)
{
	if(PosStartX == PosEndX)
	{
...
* Include			 : none
* Declaration		 : void LCD_DrawDot(U8 PosStartX,U8 PosStartY)
...
*****************************************************************************/
#if 0
void LCD_DrawDot(U8 PosStartX,U8 PosStartY)
{
...
* Include			 : none
* Declaration		 : void LCD_DrawBox(U8 PosStartX,U8 PosStartY,U8 PosEndX,U8 PosEndY,U8 fill)
...
* Calling Functions  : none
*****************************************************************************/
void LCD_DrawBox(U16 PosStartX,U16 PosStartY,U16 PosEndX,U16 PosEndY,U8 fill,U8 col1,U8 col2)
{
...
* Include			 : none
* Declaration		 : void LCD_DrawBmp(U8 PosStartX,U8 PosStartY,U8 BmpNo)
...
* Calling Functions  : none
*****************************************************************************/
void LCD_DrawBmp(U16 PosStartX,U16 PosStartY,U8 BmpNo)
{
	U16 width;
	U16 hight;
...
void Draw_PlayTimeProgressFrame(U16 PosStartX,U16 PosStartY,U16 Progress ,U8 flag)
{
	...
	if(flag==REDRAW)
	{
		LCD_DrawBox(Progress_X,PosStartY,Progress_X+PLAY_TIME_PROGRESS_LEN,PosStartY+PLAY_TIME_PROGRESS_HIGHT,1U,0x00U,0x00U);
