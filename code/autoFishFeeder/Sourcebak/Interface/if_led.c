 ...
 * Include           : none
 * Declaration       : void If_Led_InitLed(void)
 * Description       :
 * Argument          :
 * Return Value      :
 * Calling Functions :
 *****************************************************************************/
void If_Led_InitLed(void)
{
	Drv_Led_InitLed();
}
 ...
 * Calling Functions :
 *****************************************************************************/
void If_Led_SetState(U8 U8LedNo, U8 U8LedState)
{
	switch(U8LedNo)
	{
	case LED1:
...
/*****************************************************************************
 * ID                :
 * Outline           : Switch the led on/off state
 * Include           : none
 * Declaration       : void If_Led_Switch(U8 U8LedNo)
 * Description       :
 * Argument          :
 * Return Value      :
 * Calling Functions :
 *****************************************************************************/
void If_Led_Switch(U8 U8LedNo)
{
	switch(U8LedNo)
	{
	case LED1:
