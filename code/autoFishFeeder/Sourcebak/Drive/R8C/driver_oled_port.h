...
#else
#define OLED_RESST		p3_7	/*Reset*/
#define OLED_CS			p1_0		/*Chip Select*/
#define OLED_DC			p1_0		/*Data/Command Control*/
#define OLED_ENABLE		p1_1		/*Read/Write Enable*/
#define OLED_RW   		p1_2		/*Read/Write Select*/
#define OLED_RD 		p1_1			/*Read Signal*/
#define OLED_WR			p1_2		/*Write Signal*/
#define PCTRL		p6_2
#define OLED_POWER      p6_1		/*12V OLED POWER*/
#define OLED_DATA		p2			/*Data bus*/
...
#define OLED_DC_D			pd1_0			/*Data/Command Control*/
#define OLED_ENABLE_D		pd1_1			/*Read/Write Enable*/
#define OLED_RW_D   		pd1_2			/*Read/Write Select*/
#define OLED_RD_D 			pd1_1			/*Read Signal*/
#define OLED_WR_D			pd1_2			/*Write Signal*/
